...
export type ColorVariants = 'commonLight' | 'commonDark' | 'forceLight' | 'forceDark' | 'muted' | 'error' | 'commonLightInverted';
...
const COLORS = {
    ...
    commonLightInverted: 'text-light dark:text-darkGray',
